...
export default function App() {
  ...
  if (bootstrapping || !bootstrap) {
    if (!bootstrapping && !bootstrap) {
      return (
        <>
          <div className="grid min-h-dvh place-items-center bg-[var(--bg)] px-6 text-[var(--text)]">
            <div className="w-full max-w-xl rounded-[32px] border border-[var(--border)] bg-[var(--panel)] p-8 text-center shadow-[var(--shadow)]">
              ...
              <p className="mt-3 text-pretty text-sm leading-7 text-[var(--text-soft)]">
